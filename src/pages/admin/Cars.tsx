  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <Button asChild className="bg-primary hover:bg-primary-glow"><Link to="/admin/cars/new"><Plus className="mr-2 h-4 w-4" /> Add new car</Link></Button>
      </div>
                ...
                <tr key={car.id} className="hover:bg-secondary/30">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex justify-end gap-1">
                      <Button asChild variant="ghost" size="icon" className="h-8 w-8"><Link to={`/cars/${car.id}`}><Eye className="h-4 w-4" /></Link></Button>
                      <Button asChild variant="ghost" size="icon" className="h-8 w-8"><Link to={`/admin/cars/${car.id}/edit`}><Pencil className="h-4 w-4" /></Link></Button>
                      <AlertDialog>
